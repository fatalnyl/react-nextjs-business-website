...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    if (!inView) {
      ...
      animationBT.start({ opacity: 0, x: "30px" });
  ...
  return (
    <div
      ref={ref}
      className="w-full h-screen pt-20 bg-white rounded-br-[100px]"
    >
      <div className="flex flex-col p-6">
          ...
          <div className="flex flex-col items-center justify-center md:flex-1 md:items-start">
            ...
            >
              <h1
                ...
                data-scroll-speed="4"
                className="md:pt-20 pt-[180px] text-4xl md:text-6xl tracking-wide md:tracking-normal text-center text-gray-700"
              >
                Global Search
                <br />
            ...
            <div className="pt-10 max-w-[700px] text-center text-xl md:text-left">
              <p>
                ...
                sunt ut modi. Similique, provident perferendis!
              </p>
            </div>
            <div className="pt-10">
              <button className="flex items-center bg-[#c61526] rounded-xl justifu-center p-4 text-white gap-4 text-xl hover-scale-110 transition-all ease-out">
        ...
        <div className="flex items-center justify-center gap-8 we-full my-3  md:hidden max-w-[80%] mx-auto mt-10">
