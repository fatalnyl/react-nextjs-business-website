      ...
      >
        ...
        >
          ...
          <div className="my-4 border-b border-gray-300">
            <p className="w-[85%] md:w-[95%] py-4 mx-auto">
          ...
          <div className="flex flex-col py-4">
            <ul className="uppercase">
              ...
              <Link href="/">
                <li className="py-4 text-sm">Business</li>
              </Link>
              <Link href="/">
                <li className="py-4 text-sm">Services</li>
              </Link>
              <Link href="/">
                <li className="py-4 text-sm">Team</li>
              </Link>
            </ul>
            <div className="pt-20">
              ...
              <div className="flex items-center justify-between my-3 w-full sm:w-[80%]">
                <div className="p-3 rounded-full shadow-lg shadow-gray-400 hover:scale-105 cursor-pointer">
                  <FaLinkedinIn />
                </div>
                <div className="p-3 rounded-full shadow-lg shadow-gray-400 hover:scale-105 cursor-pointer">
                  <FaGithub />
